...
INSERT INTO "new_Link" ("clicks", "createdAt", "id", "isDirect", "shortCode", "title", "updatedAt", "url") SELECT "clicks", "createdAt", "id", "isDirect", "shortCode", "title", "updatedAt", "url" FROM "Link";
DROP TABLE "Link";
