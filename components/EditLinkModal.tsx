      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed inset-0 md:inset-auto md:top-0 md:left-1/2 md:-translate-x-1/2 md:bottom-0 md:h-full md:w-full md:max-w-xl lg:max-w-2xl bg-white dark:bg-gray-800 shadow-2xl z-50 flex flex-col"
          >
            {/* Header */}
