...
export default function Dashboard() {
  ...
  const fetchLinks = async () => {
    try {
      ...
      const total = data.reduce((sum: number, link: LinkData) => sum + link.clicks, 0)
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
        ...
        <div className="relative px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mb-8">
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-200/50 dark:border-gray-700/50 p-4 sm:p-6 transform hover:scale-105 transition-all">
              ...
              <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-300 mt-1">Total Links</div>
            </div>
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-200/50 dark:border-gray-700/50 p-4 sm:p-6 transform hover:scale-105 transition-all">
              ...
              <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-300 mt-1">Total Clicks</div>
            </div>
            <div className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-200/50 dark:border-gray-700/50 p-4 sm:p-6 transform hover:scale-105 transition-all">
              ...
              <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-300 mt-1">Avg Clicks</div>
            </div>
            <Link href="/analytics" className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-sm rounded-2xl shadow-lg border border-gray-200/50 dark:border-gray-700/50 p-4 sm:p-6 transform hover:scale-105 transition-all group">
              <div className="text-2xl sm:text-3xl mb-1 group-hover:scale-110 transition-transform">📊</div>
              <div className="text-xs sm:text-sm text-gray-600 dark:text-gray-300 group-hover:text-indigo-600 dark:group-hover:text-indigo-400 transition-colors">View Analytics</div>
            </Link>
          </div>
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-8 max-w-7xl mx-auto">
        ...
        <div className={`lg:hidden fixed inset-x-0 bottom-0 bg-white dark:bg-gray-900 rounded-t-3xl shadow-2xl transform transition-transform duration-300 ease-out z-40 ${
          showMobileForm ? 'translate-y-0' : 'translate-y-full'
        }`}>
          <div className="p-6">
            <div className="flex items-center justify-between mb-4">
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">Create New Link</h3>
              <button
        ...
        <div className="hidden lg:grid lg:grid-cols-3 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="sticky top-24">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Create New Link</h2>
              <LinkForm onLinkCreated={handleLinkCreated} />
              <div className="mt-6">
                <UsageLimits />
              </div>
          ...
          <div className="lg:col-span-2">
            <h2 className="text-2xl font-bold text-gray-900 dark:text-white mb-6">Your Links</h2>
            {loading ? (
              ...
              <div className="text-center py-16">
                ...
                <p className="text-gray-600 dark:text-gray-400">Create your first protected link to get started</p>
              </div>
            ) : (
              <LinkList 
                links={links} 
        ...
        {/* Mobile Links List */}
        <div className="lg:hidden">
          <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-4">Your Links</h2>
          {loading ? (
            ...
            <div className="text-center py-12">
              ...
              <h3 className="text-base font-medium text-gray-900 dark:text-white mb-1">No links yet</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">Tap the button above to create your first link</p>
            </div>
          ) : (
            <LinkList 
              links={links} 
